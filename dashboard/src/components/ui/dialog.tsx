...
>(({ className, children, hideCloseButton = false, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      {!hideCloseButton && (
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg p-1.5 text-muted-foreground transition-[color,background-color] duration-150 hover:bg-muted hover:text-foreground focus:outline-none focus:ring-[3px] focus-visible:ring-ring disabled:pointer-events-none data-[state=open]:bg-accent">
          <X className="h-4 w-4" />
