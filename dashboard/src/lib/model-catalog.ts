...
export const PROVIDER_TEMPLATES: ProviderTemplate[] = [
  ...
  },
  {
    ...
    models: ['openrouter/auto', 'anthropic/claude-fable-5', 'anthropic/claude-opus-4.8', 'anthropic/claude-sonnet-4.6', 'openai/gpt-5.5', 'deepseek/deepseek-v4-pro', 'google/gemini-3.5-flash', 'qwen/qwen-plus'],
