...
export const PROVIDER_TEMPLATES: ProviderTemplate[] = [
  ...
  },
  {
    ...
    baseUrlEnv: 'ROUTEPILOT_OPENAI_BASE_URL',
    apiKeyEnv: 'ROUTEPILOT_OPENAI_API_KEY',
    apiKeyRequired: true,
    ...
    passthroughUnknownModels: false,
    maxTokensField: 'max_completion_tokens',
    notes: 'RoutePilot 服务端的官方 OpenAI 上游；客户端连接网关时仍使用标准 OPENAI_* 变量。',
  },
  {
    id: 'anthropic',
...
export function providerEnv(template: ProviderTemplate): string {
  ...
  return [
    ...
    keyLine,
    `export ROUTEPILOT_ENABLE_${template.id.toUpperCase()}=1`,
  ].join('\n')
}
