...
export const modelsService = {
  ...
  createProvider: async (payload: ProviderWritePayload): Promise<Provider> => {
    ...
    const provider: Provider = {
      ...
      staticHeaders: payload.staticHeaders ?? {},
      requestTimeoutMs: payload.requestTimeoutMs ?? null,
      streamIdleTimeoutMs: payload.streamIdleTimeoutMs ?? null,
      retry: payload.retry ?? { max_attempts: 1, initial_delay_ms: 250, max_delay_ms: 5000, jitter_ratio: 0.1 },
