...
Starts or updates the local Compose deployment. If PostgreSQL is already
running, a read-only major-version, volume, migration, and state check must pass
before Compose may recreate any service.
USAGE
  exit 0
fi
